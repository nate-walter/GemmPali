...
INIT_HEAD="/home/nate/GemmPali/checkpoints/phase2_run1/head_step_0004500.pt"

# Phase 2 refinement: start from best phase2_run1 head + tighter eval reliability
